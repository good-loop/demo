...
const { targetServer, customVertId } = require('../utils/testConfig');

const targetUrl = targetServer[config.site];
...
describe('Demo page video tests', () => {
	...
	it('should have a fullscreen button matching url id', async () => {
		await page.goto(APIBASE + `/?gl.vert=${customVertId[config.site]}`);
	...
	it('should display correct player/format upon clicking widget buttons', async () => {
		//// ANOTHER JOURNEY ////////////////////////////////
		await page.goto(APIBASE); // go to page
