...
#####
PROJECT_NAME='demo' #This name will be used to create/or/refer-to the directory of the project in /home/winterwell/
...
PROJECT_USES_AUTOMATED_TESTING='no' #NOT YET CONFIGURED
