...
# Team-City :: Update the testdemo.good-loop.com Site in a CI fashion
...
SERVICE_NAME=('')
PLEASE_SYNC=("config" "pages" "package.json" "ssl.testdemo.good-loop.com.conf" "ssl.demo.good-loop.com" "web-demo" "web-test" "webpack.config.js" "src")
