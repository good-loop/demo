    ...
    <div class="row d-none d-sm-block d-md-block">
        <div class="col-md-12">
            <div class="row">
                ...
                <div id="demo-wrapper">
                    <div id="demo-text">OUR ETHICAL ADS SIT IN A RAGE OF STANDARD FORMATS, SUCH AS...</div> 
                    <div id="demo"></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="row">
                <div id="demo-mobile-wrapper">
                    <div id="demo-mobile-text">OUR ETHICAL ADS SIT IN A RAGE OF STANDARD FORMATS, SUCH AS...</div> 
                    <div id="demo-mobile"></div>
                </div>
            </div>
        </div>
    </div>
