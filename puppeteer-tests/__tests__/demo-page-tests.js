...
const {DemoPageSelectors} = require('../test-base/utils/SelectorsMaster');
const {APIBASE, fillInForm, watchAdvertAndDonate} = require('../test-base/babeled-res/UtilityFunctions');
...
const variants = ['mpu2', 'pre-roll', 'in-read', 'mpu'];
