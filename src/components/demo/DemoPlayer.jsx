...
const urlParams = ({format, device}) => {
	window.history.pushState('string', null, `?format=${format}&device=${device}`);
}

const DemoPlayer = ({ vertId, production, noSocial, adBlockerDetected, format, device }) => {
